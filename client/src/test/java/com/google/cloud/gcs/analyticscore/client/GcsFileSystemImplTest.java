...
class GcsFileSystemImplTest {
    ...
    @Test
    void open_withNonExistentObjectPath_shouldThrowException() throws URISyntaxException,IOException {
        ...
        IOException e = assertThrows(IOException.class, () -> gcsFileSystem.open(nonExistentPath, readOptions));
    ...
    void open_withNullPath_throwsException() {
        ...
        NullPointerException e = assertThrows(NullPointerException.class, () -> gcsFileSystem.open(null,
                readOptions));
    ...
    void open_withBucketPath_shouldThrowException() throws URISyntaxException {
        ...
        IllegalArgumentException e =
                assertThrows(
                        ...
                        () -> gcsFileSystem.open(bucketPath, readOptions));
    ...
    @Test
    void getFileInfo_withNonExistentPath_shouldThrowException() throws URISyntaxException, IOException {
        GcsItemId nonExistentItemId =
                GcsItemId.builder().setBucketName(TEST_BUCKET).setObjectName("non-existent-object").build();
        URI nonExistentPath = new URI("gs://" + TEST_BUCKET + "/non-existent-object");
        ...
        IOException e = assertThrows(IOException.class, () -> gcsFileSystem.getFileInfo(nonExistentPath));
