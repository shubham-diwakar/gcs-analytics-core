...
class GcsReadChannelTest {
    ...
    void constructor_nullStorage_throwsNullPointerException() {
        ...
        NullPointerException e = assertThrows(NullPointerException.class, () -> new GcsReadChannel(null, itemInfo,
    ...
    void constructor_nullItemInfo_throwsNullPointerException() {
        NullPointerException e = assertThrows(NullPointerException.class, () -> new GcsReadChannel(storage, null,
                TEST_GCS_READ_OPTIONS));
    ...
    void position_negative_throwsEOFException() throws IOException {
        ...
        assertThat(e).hasMessageThat().contains("Invalid seek offset: position value (-1) must be >= 0");
    }
    ...
    void position_equalToSize_throwsEOFException() throws IOException {
        ...
        assertThat(e).hasMessageThat().contains(String.format("Invalid seek offset: position value (11) must be " +
                "between 0 and 11 for ", itemInfo.getItemId()));
    }
    ...
    void position_greaterThanSize_throwsEOFException() throws IOException {
        ...
        assertThat(e).hasMessageThat().contains(String.format("Invalid seek offset: position value (%d) must be " +
                "between 0 and %d", size + 1, size));
    }
